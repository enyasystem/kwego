...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-belfx_navy-light">
      <AdminSidebar
        tab={tab}
        setTab={setTab}
      ...
      />
      <main className="flex-1 max-w-7xl mx-auto py-10 px-2 md:px-8">
        {loading && (
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="bg-belfx_navy-DEFAULT rounded-t-lg shadow-sm flex flex-row items-center justify-between">
...
// Commit message: feat(admin): add modern sidebar layout and structure for admin dashboard 🧑‍💻
