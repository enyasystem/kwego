...
const AdminDashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-2 md:px-0 relative">
      {loading && (
      ...
      <Card className="shadow-xl border-0">
        <CardHeader className="bg-belfx_navy-DEFAULT rounded-t-lg shadow-sm sticky top-0 z-20 flex flex-row items-center justify-between">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 focus:outline-none">
                  <Avatar className="w-9 h-9 border-2 border-belfx_gold-DEFAULT">
                  ...
                  <span className="hidden md:inline text-belfx_gold-DEFAULT font-semibold">{adminProfile.full_name || adminProfile.email}</span>
                </button>
              </DropdownMenuTrigger>
        ...
        <CardContent>
          <Tabs value={tab} onValueChange={setTab} className="w-full">
            <TabsList className="mb-6 flex flex-wrap gap-2 sticky top-20 z-10 bg-belfx_navy-DEFAULT/80 backdrop-blur rounded-lg shadow-sm">
